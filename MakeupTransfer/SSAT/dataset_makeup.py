...
class MakeupDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        if self.opt.phase == 'test_pair':
            ...
            original_size = Image.open(self.non_makeup_path[non_makeup_index]).size
            data = {'non_makeup': torch.from_numpy(non_makeup_img).type(torch.FloatTensor),
                    ...
                    'non_makeup_path': self.non_makeup_path[non_makeup_index],
                    'makeup_path': self.makeup_path[makeup_index],
